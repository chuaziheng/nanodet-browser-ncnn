...
def color_aug_and_norm(meta, kwargs):
    ...
    # cv2.imshow('trans', img)  # DEBUG

    cv2.imwrite(rf"C:\Users\chuaz\test-videoio\nanodet\data\dataset\coco\test_sliced_artemia\{time.time()}.png", img*255) # To get sliced processed images for NCNN
    # time.sleep(1)  #used to check that the images are sliced correctly
